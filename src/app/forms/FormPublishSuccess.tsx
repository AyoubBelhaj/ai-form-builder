        ...
        <Dialog open={props.open} onOpenChange={props.onOpenChange}>
            <DialogContent className='sm:max-w-[425px]'>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Your form is now live and ready to be filled out by your users. You can now sahre the form by clicking the link below.
                    </DialogDescription>
                </DialogHeader>
                <div className='flex flex-col'><p>Copy link</p>
                    <div className='border-2 border-gray-200 flex justify-between items-center mt-2 pl-2 rounded-md'>
                        ...
                        <Input className='w-full outline-none bg-transparent' type='text' placeholder='link' disabled value={`${baseUrl}/forms/${props.formId}`} />
